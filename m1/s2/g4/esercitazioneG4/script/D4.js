  ...
  */
  ...
  for(let i = 0; i < starWarsCharacters.length; i++){
    switch(starWarsCharacters[i].eye_color){
      case 'blue': eyeColor.blue.push(i)
      break
      case 'yellow': eyeColor.yellow.push(i)
      break
      case 'brown': eyeColor.brown.push(i)
      break
      case 'red': eyeColor.red.push(i)
      break
      case 'blue-gray': eyeColor.blueGray.push(i)
      break
    }
  }
  console.log(eyeColor)
...
for(let i = 0; i < starWarsCharacters.length; i++){
  switch(true){
    ...
    case totalMass > 700 && totalMass < 900:
      ...
      break
    case totalMass > 900:
      console.log('Critical Load: Over 900') // I HAVE A BAD FEELING ABOUT THIS...
      break
    case totalMass > 1000:
...
//causa viaggio nell'iperspazio ho finito il tempo per completare l'esercizio, intanto elimino basandomi sull'indice dell'array che posso trovare con due for loop
...
//console.log(`Il nome del personaggio è ${name}, la sua altezza è ${height}, la sua massa equivale a ${mass}, i suoi capelli sono ${hair_color}, ha la pelle ${skin_color}, gli occhi ${eye_color}, nasce il ${birth_year}, si identifica come ${gender}.`)